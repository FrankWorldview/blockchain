...
## 🔄 Dynamic Metadata vs. 📦 Static Metadata (using `ERC721URIStorage`)
...
```
> 🧠 This JSON file is used by wallets and NFT marketplaces (like OpenSea or Rarible)  
> to display the NFT’s **image**, **name**, and **attributes** in a user-friendly way.
